...
static void* R_Integer_Methods(const R_Face* interface);
...
static void R_Integer_puts(R_Integer* self) {
...
static void* R_Float_Methods(const R_Face* interface);
...
static void R_Float_puts(R_Float* self) {
...
static void* R_Unsigned_Methods(const R_Face* interface);
...
static void R_Unsigned_puts(R_Unsigned* self) {
...
static void* R_Boolean_Methods(const R_Face* interface);
...
static void R_Boolean_puts(R_Boolean* self) {
