...
#define R_Face_DeclareCaller(name, return_type, ...) return_type R_FUNCTION_ATTRIBUTES R_Face_Caller__##name(void* f, __VA_ARGS__)
...
void R_FUNCTION_ATTRIBUTES R_Puts(void* object);

R_Face_Declare(R_Equals, int, void* object_a, void* object_b)
int R_FUNCTION_ATTRIBUTES R_Equals(void* object_a, void* object_b);
